...
> El comando original de la doc apuntaba a `ATC\.venv\Scripts\python.exe` (Windows). En macOS eso no sirve — ver [[Levantar Servidor]]. En este equipo el runtime es Python **3.14.5**.
